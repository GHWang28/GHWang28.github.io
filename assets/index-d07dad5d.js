import{af as t,k as p,a as l,j as o,B as k}from"./index-f17cb10e.js";import{v as x}from"./v4-4a60fe23.js";const h=(r="hsl(50deg, 100%, 50%)",s=t(25,75))=>({id:x(),timestamp:Date.now(),color:r,size:s,style:{top:`${t(0,100)}%`,left:`${t(0,100)}%`,zIndex:2}}),g=p`
  0% {
    transform: scale(0);
  }
  50% {
