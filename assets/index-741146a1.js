import{a5 as t,k as p,a as l,j as o,B as k}from"./index-705ef674.js";import{v as x}from"./v4-a960c1f4.js";const h=(r="hsl(50deg, 100%, 50%)",s=t(25,75))=>({id:x(),timestamp:Date.now(),color:r,size:s,style:{top:`${t(0,100)}%`,left:`${t(0,100)}%`,zIndex:2}}),g=p`
  0% {
    transform: scale(0);
  }
  50% {
